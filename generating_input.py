...
pull_hand_in78 = Gesture("77", "pull_hand_in", "1.0", "1.0", "1.0", "90.0")
slide_2_fingers_right78 = Gesture("77", "slide_2_fingers_right", "1.0", "1.0", "1.0", "89.0")
slide_2_fingers_up78 = Gesture("77", "slide_2_fingers_up", "1.0", "1.0", "1.0", "88.0")
stop_sign78 = Gesture("77", "stop_sign", "1.0", "1.0", "1.0", "90.0")
swipe_down78 = Gesture("77", "swipe_down", "1.0", "1.0", "1.0", "86.0")
swipe_left78 = Gesture("77", "swipe_left", "1.0", "1.0", "1.0", "88.0")
thumb_up78 = Gesture("77", "thumb_up", "1.0", "1.0", "1.0", "86.0")
zoom_in_with_2_fingers78 = Gesture("77", "zoom_in_with_2_fingers", "1.0", "1.0", "1.0", "91.0")
...
exp_2.writeNewFile(filenameExp_path)
exp_3.writeNewFile(filenameExp_path)
exp_4.append_row(filenameExp_path)
exp_5.writeNewFile(filenameExp_path)
exp_6.writeNewFile(filenameExp_path)
exp_7.append_row(filenameExp_path)
exp_8.writeNewFile(filenameExp_path)
exp_9.writeNewFile(filenameExp_path)
exp_10.writeNewFile(filenameExp_path)
exp_11.append_row(filenameExp_path)
exp_12.writeNewFile(filenameExp_path)
exp_13.writeNewFile(filenameExp_path)
exp_14.writeNewFile(filenameExp_path)
exp_15.append_row(filenameExp_path)
exp_16.writeNewFile(filenameExp_path)
exp_17.writeNewFile(filenameExp_path)
exp_18.writeNewFile(filenameExp_path)
exp_19.writeNewFile(filenameExp_path)
exp_20.writeNewFile(filenameExp_path)
exp_21.writeNewFile(filenameExp_path)
exp_22.append_row(filenameExp_path)
exp_23.writeNewFile(filenameExp_path)
exp_24.append_row(filenameExp_path)
exp_25.writeNewFile(filenameExp_path)
exp_26.writeNewFile(filenameExp_path)
exp_27.append_row(filenameExp_path)
exp_28.writeNewFile(filenameExp_path)
exp_29.writeNewFile(filenameExp_path)
exp_30.append_row(filenameExp_path)
exp_31.writeNewFile(filenameExp_path)
exp_32.writeNewFile(filenameExp_path)
exp_33.append_row(filenameExp_path)
exp_34.append_row(filenameExp_path)
exp_35.writeNewFile(filenameExp_path)
exp_36.writeNewFile(filenameExp_path)
exp_37.append_row(filenameExp_path)
exp_38.append_row(filenameExp_path)
exp_39.writeNewFile(filenameExp_path)
exp_40.writeNewFile(filenameExp_path)
exp_41.append_row(filenameExp_path)
exp_42.append_row(filenameExp_path)
exp_43.writeNewFile(filenameExp_path)
exp_44.writeNewFile(filenameExp_path)
exp_45.writeNewFile(filenameExp_path)
exp_46.writeNewFile(filenameExp_path)
exp_47.writeNewFile(filenameExp_path)
exp_48.writeNewFile(filenameExp_path)
exp_49.writeNewFile(filenameExp_path)
exp_50.writeNewFile(filenameExp_path)
exp_51.append_row(filenameExp_path)
exp_52.writeNewFile(filenameExp_path)
exp_53.writeNewFile(filenameExp_path)
exp_54.append_row(filenameExp_path)
exp_55.writeNewFile(filenameExp_path)
exp_56.append_row(filenameExp_path)
exp_57.writeNewFile(filenameExp_path)
exp_58.writeNewFile(filenameExp_path)
exp_59.append_row(filenameExp_path)
exp_60.writeNewFile(filenameExp_path)
exp_61.writeNewFile(filenameExp_path)
exp_62.writeNewFile(filenameExp_path)
exp_63.writeNewFile(filenameExp_path)
exp_64.writeNewFile(filenameExp_path)
exp_65.writeNewFile(filenameExp_path)
exp_66.writeNewFile(filenameExp_path)
exp_67.writeNewFile(filenameExp_path)
exp_68.writeNewFile(filenameExp_path)
exp_69.append_row(filenameExp_path)
exp_70.writeNewFile(filenameExp_path)
exp_71.append_row(filenameExp_path)
exp_72.writeNewFile(filenameExp_path)
exp_73.append_row(filenameExp_path)
exp_74.writeNewFile(filenameExp_path)
exp_75.append_row(filenameExp_path)
exp_76.append_row(filenameExp_path)
exp_77.writeNewFile(filenameExp_path)
exp_78.writeNewFile(filenameExp_path)
exp_79.writeNewFile(filenameExp_path)
exp_80.writeNewFile(filenameExp_path)
exp_81.writeNewFile(filenameExp_path)
exp_82.append_row(filenameExp_path)
exp_83.writeNewFile(filenameExp_path)
exp_84.writeNewFile(filenameExp_path)
exp_85.append_row(filenameExp_path)
exp_86.writeNewFile(filenameExp_path)
exp_87.writeNewFile(filenameExp_path)
exp_88.append_row(filenameExp_path)
exp_89.append_row(filenameExp_path)
exp_90.writeNewFile(filenameExp_path)
exp_91.writeNewFile(filenameExp_path)
exp_92.writeNewFile(filenameExp_path)
exp_93.writeNewFile(filenameExp_path)
exp_94.writeNewFile(filenameExp_path)
exp_95.writeNewFile(filenameExp_path)
exp_96.writeNewFile(filenameExp_path)
exp_97.writeNewFile(filenameExp_path)
exp_98.writeNewFile(filenameExp_path)
exp_99.writeNewFile(filenameExp_path)
exp_100.writeNewFile(filenameExp_path)
exp_101.writeNewFile(filenameExp_path)
exp_102.writeNewFile(filenameExp_path)
exp_103.writeNewFile(filenameExp_path)
exp_104.writeNewFile(filenameExp_path)

# Writing the experiments metrics
exp1_metrics.writeNewFile(filenameMetrics_path)
exp2_metrics.writeNewFile(filenameMetrics_path)
exp3_metrics.writeNewFile(filenameMetrics_path)
exp4_metrics.append_row(filenameMetrics_path)
exp5_metrics.writeNewFile(filenameMetrics_path)
exp6_metrics.writeNewFile(filenameMetrics_path)
exp7_metrics.append_row(filenameMetrics_path)
exp8_metrics.writeNewFile(filenameMetrics_path)
exp9_metrics.writeNewFile(filenameMetrics_path)
exp10_metrics.writeNewFile(filenameMetrics_path)
exp11_metrics.append_row(filenameMetrics_path)
exp12_metrics.writeNewFile(filenameMetrics_path)
exp13_metrics.writeNewFile(filenameMetrics_path)
exp14_metrics.writeNewFile(filenameMetrics_path)
exp15_metrics.append_row(filenameMetrics_path)
exp16_metrics.writeNewFile(filenameMetrics_path)
exp17_metrics.writeNewFile(filenameMetrics_path)
exp18_metrics.writeNewFile(filenameMetrics_path)
exp19_metrics.writeNewFile(filenameMetrics_path)
exp20_metrics.writeNewFile(filenameMetrics_path)
exp21_metrics.writeNewFile(filenameMetrics_path)
exp22_metrics.append_row(filenameMetrics_path)
exp23_metrics.writeNewFile(filenameMetrics_path)
exp24_metrics.append_row(filenameMetrics_path)
exp25_metrics.writeNewFile(filenameMetrics_path)
exp26_metrics.writeNewFile(filenameMetrics_path)
exp27_metrics.append_row(filenameMetrics_path)
exp28_metrics.writeNewFile(filenameMetrics_path)
exp29_metrics.writeNewFile(filenameMetrics_path)
exp30_metrics.append_row(filenameMetrics_path)
exp31_metrics.writeNewFile(filenameMetrics_path)
exp32_metrics.writeNewFile(filenameMetrics_path)
exp33_metrics.append_row(filenameMetrics_path)
exp34_metrics.append_row(filenameMetrics_path)
exp35_metrics.writeNewFile(filenameMetrics_path)
exp36_metrics.writeNewFile(filenameMetrics_path)
exp37_metrics.append_row(filenameMetrics_path)
exp38_metrics.append_row(filenameMetrics_path)
exp39_metrics.writeNewFile(filenameMetrics_path)
exp40_metrics.writeNewFile(filenameMetrics_path)
exp41_metrics.append_row(filenameMetrics_path)
exp42_metrics.append_row(filenameMetrics_path)
exp43_metrics.writeNewFile(filenameMetrics_path)
exp44_metrics.writeNewFile(filenameMetrics_path)
exp45_metrics.writeNewFile(filenameMetrics_path)
exp46_metrics.writeNewFile(filenameMetrics_path)
exp47_metrics.writeNewFile(filenameMetrics_path)
exp48_metrics.writeNewFile(filenameMetrics_path)
exp49_metrics.writeNewFile(filenameMetrics_path)
exp50_metrics.writeNewFile(filenameMetrics_path)
exp51_metrics.append_row(filenameMetrics_path)
exp52_metrics.writeNewFile(filenameMetrics_path)
exp53_metrics.writeNewFile(filenameMetrics_path)
exp54_metrics.append_row(filenameMetrics_path)
exp55_metrics.writeNewFile(filenameMetrics_path)
exp56_metrics.append_row(filenameMetrics_path)
exp57_metrics.writeNewFile(filenameMetrics_path)
exp58_metrics.writeNewFile(filenameMetrics_path)
exp59_metrics.append_row(filenameMetrics_path)
exp60_metrics.writeNewFile(filenameMetrics_path)
exp61_metrics.writeNewFile(filenameMetrics_path)
exp62_metrics.writeNewFile(filenameMetrics_path)
exp63_metrics.writeNewFile(filenameMetrics_path)
exp64_metrics.writeNewFile(filenameMetrics_path)
exp65_metrics.writeNewFile(filenameMetrics_path)
exp66_metrics.writeNewFile(filenameMetrics_path)
exp67_metrics.writeNewFile(filenameMetrics_path)
exp68_metrics.writeNewFile(filenameMetrics_path)
exp69_metrics.append_row(filenameMetrics_path)
exp70_metrics.writeNewFile(filenameMetrics_path)
exp71_metrics.append_row(filenameMetrics_path)
exp72_metrics.writeNewFile(filenameMetrics_path)
exp73_metrics.append_row(filenameMetrics_path)
exp74_metrics.writeNewFile(filenameMetrics_path)
exp75_metrics.append_row(filenameMetrics_path)
exp76_metrics.append_row(filenameMetrics_path)
exp77_metrics.writeNewFile(filenameMetrics_path)
exp78_metrics.writeNewFile(filenameMetrics_path)
exp79_metrics.writeNewFile(filenameMetrics_path)
exp80_metrics.writeNewFile(filenameMetrics_path)
exp81_metrics.writeNewFile(filenameMetrics_path)
exp82_metrics.append_row(filenameMetrics_path)
exp83_metrics.writeNewFile(filenameMetrics_path)
exp84_metrics.writeNewFile(filenameMetrics_path)
exp85_metrics.append_row(filenameMetrics_path)
exp86_metrics.writeNewFile(filenameMetrics_path)
exp87_metrics.writeNewFile(filenameMetrics_path)
exp88_metrics.append_row(filenameMetrics_path)
exp89_metrics.append_row(filenameMetrics_path)
exp90_metrics.writeNewFile(filenameMetrics_path)
exp91_metrics.writeNewFile(filenameMetrics_path)
exp92_metrics.writeNewFile(filenameMetrics_path)
exp93_metrics.writeNewFile(filenameMetrics_path)
exp94_metrics.writeNewFile(filenameMetrics_path)
exp95_metrics.writeNewFile(filenameMetrics_path)
exp96_metrics.writeNewFile(filenameMetrics_path)
exp97_metrics.writeNewFile(filenameMetrics_path)
exp98_metrics.writeNewFile(filenameMetrics_path)
exp99_metrics.writeNewFile(filenameMetrics_path)
exp100_metrics.writeNewFile(filenameMetrics_path)
exp101_metrics.writeNewFile(filenameMetrics_path)
exp102_metrics.writeNewFile(filenameMetrics_path)
exp103_metrics.writeNewFile(filenameMetrics_path)
exp104_metrics.writeNewFile(filenameMetrics_path)
